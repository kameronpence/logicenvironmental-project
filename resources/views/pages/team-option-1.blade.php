...
@section('title', 'Our Team - Option 1 (Minimal Clean)')

@section('content')
<!-- Page Header -->
<section class="hero" style="padding: 60px 0;">
    <div class="container text-center">
        <h1 class="display-5 fw-bold text-white">Our Team - Option 1</h1>
        <p class="text-white-50">Minimal Clean - Click card to view bio</p>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 col-lg-3 mb-4">
                <div class="card border-0 shadow-sm h-100 team-card-minimal" data-bs-toggle="modal" data-bs-target="#teamModal{{ $member->id }}" style="cursor: pointer;">
                    @if($member->photo)
                        <img src="{{ $member->photo_url }}" class="card-img-top" alt="{{ $member->name }}" style="height: 300px; object-fit: cover;">
                    @else
