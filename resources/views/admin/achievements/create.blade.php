...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1 class="h3 mb-0">Add Achievement</h1>
        ...
        <form action="{{ route('admin.achievements.store') }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control @error('icon') is-invalid @enderror" id="icon" name="icon" value="{{ old('icon', 'fa-award') }}" required>
                </div>
