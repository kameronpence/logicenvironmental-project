                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text"><i id="iconPreview" class="fas {{ $service->icon }}"></i></span>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('short_description') is-invalid @enderror"
                                  ...
                                  placeholder="Brief description shown on the card">{{ old('short_description', $service->short_description) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('full_description') is-invalid @enderror"
                                  ...
                                  placeholder="Detailed description shown in the modal popup">{{ old('full_description', $service->full_description) }}</textarea>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="sort_order"
                               name="sort_order" value="{{ old('sort_order', $service->sort_order) }}">
            ...
            <div class="card border-0 shadow-sm mb-4">
                ...
                <div class="card-body">
                    <div class="card h-100 text-center p-3" id="cardPreview">
                        <div class="card-body">
                            <i id="previewIcon" class="fas {{ $service->icon }} fa-3x text-primary mb-3"></i>
                            <h5 id="previewTitle" class="card-title">{{ $service->title }}</h5>
                            <p id="previewDesc" class="card-text text-muted small">{{ Str::limit($service->short_description, 80) }}</p>
                        </div>
                    </div>
                </div>
            </div>
